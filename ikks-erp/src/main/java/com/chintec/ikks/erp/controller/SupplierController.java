...
public class SupplierController {
    ...
    @PermissionAnnotation(code = "2006")
    public ResultResponse supplier(@PathVariable Integer id, @RequestParam(required = false) Integer qualificationId) {
        return iSupplierErpService.supplier(id, qualificationId);
    }
